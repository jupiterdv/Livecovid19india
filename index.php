...
function showResult(str) {
  if (str.length==0) {
    ...
    document.getElementById("livesearch").style.border="1px solid #243aff";
    return;
  }
...
<meta name="theme-color" content="#000">
  ...
  <meta name="author" content="Tiprasa Coders Community">
 
    <link rel="icon" type="image/png" href="./images/1icon_32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="./images/1icon_16.png" sizes="16x16">
    <link rel="icon" href="./images/pic.png" sizes="16x16 32x32" type="image/png">
...
<img border="0" src="pic2.png" alt="Corona live update" style="width:100px;height:100px;"></a></div>
...
<div class="topnav" id="myTopnav">
  ...
  <a href="#home" class="active"> <img border="0" src="corona.png" alt="Corona live update" style="width:20px;height:20px;"></a></a>
  
   
  <a href="https://thecodezine.com/covid19/statewise.php">Statewise Live Updates</a>
  <a href="https://thecodezine.com/covid19/distind.php">Districtwise Live Updates</a>
<a href="https://thecodezine.com/covid19/analytics.php">Time Series</a>

  <a href="https://thecodezine.com/covid19/zones.php">Covid-19 Zones Updates</a>
  <a href="https://thecodezine.com/covid19/enquiry.php">Enquiry Helpline</a>
   <a href="https://thecodezine.com/covid19/tripura.php">Tripura Live Updates</a>
   <a href="https://covid19.thecodezine.com/world/">Global Live Updates</a>
   <a href="https://thecodezine.com/covid19/testing.php">Testing Report</a>
  
   <a href="https://thecodezine.com/covid19/survey.php">Covid-19 Survey</a>
   
<a href="https://thecodezine.com/covid19/about.php">FAQ/About</a>
...
<div align="center">
   <a href="https://www.paypal.me/jupiterdebbarma" class="btn btn-default btn btn-danger"><i class="fas fa-hand-holding-heart"></i><strong>Donate!</strong></a>
   <hr>
    <form>
<input type="text" size="35"  placeholder="🔍 Search Here..." onkeyup="showResult(this.value)">
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-1072434877178884"
     data-ad-slot="5958762593"
     data-ad-format="auto"
...
<div class="text-center table-responsive">
	<table class="table table-bordered table-striped table-transparent text-secondary" id="corona_table">
		<tr>
			
			<th bgcolor="#f59e42"> State</th>
			<th bgcolor="#ffcc24"> Last update</th>
			<th bgcolor="#ff2929">Confirmed</th>
			<th bgcolor="#ff2929">[+]</th>
			<th bgcolor="#2930ff">Active</th>
			<th bgcolor="#29ff2d">Recovered </th>
			<th bgcolor="#29ff2d">[+]</th>
			<th bgcolor="#9d9e9d">Deaths</th>
			
			<th bgcolor="#9d9e9d">[+]</th>
...
/*Passing php states array to  javascript variable*/	
	...
	y.insertCell(3);
	corona_table.rows[i].cells[3].innerHTML= state[i]['deltaconfirmed'];	

	y.insertCell(4);
	corona_table.rows[i].cells[4].innerHTML= state[i]['active'];	

	y.insertCell(5);
	corona_table.rows[i].cells[5].innerHTML= state[i]['recovered'];
	
	y.insertCell(6);
	corona_table.rows[i].cells[6].innerHTML= state[i]['deltarecovered'];
	
	y.insertCell(7);
	corona_table.rows[i].cells[7].innerHTML= state[i]['deaths'];
	
    y.insertCell(8);
	corona_table.rows[i].cells[8].innerHTML= state[i]['deltadeaths'];

		
	}

/*All India Data*/
document.getElementById('TC').innerHTML =state[0]['deltaconfirmed'];
	 
document.getElementById('TR').innerHTML =state[0]['deltarecovered'];	 
document.getElementById('TD').innerHTML =state[0]['deltadeaths'];
document.getElementById('LUD').innerHTML =state[0]['lastupdatedtime'];
  ...
  if (darkSwitch.checked) {
   ...
   <script type="text/javascript">
    ...
    <ul class="social-icons">
     ...
     <div class="container text-center"><span class="text-primary" >Built by Proud Indian 🇮🇳 & Proud Tripuri.</span> <span class="text-primary" >Copyright &copy;2020,<a href="https://thecodezine.com" target="_blank">TCC</a></span > </div> 
</footer> 
...
$(document).ready(function () {
    ...
    $("body").on("contextmenu",function(e){
         alert('Sorry Inspect not allowed!');
        return false;
    });
});
</script>
